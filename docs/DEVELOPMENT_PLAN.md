...
> **注記（2026-09-10）**: この文書は 2026-01-31 時点の計画の記録。ここで「未実装」とある項目
> （車検管理・法人機能など）の多くはその後実装済み。現在の実装状況は `docs/FEATURE_SPEC.md` の
> 「実装状況の照合」、層ごとの実数は `docs/ARCHITECTURE.md` を見ること。
