...
**先に価格を決める必要があります: `docs/PRICING_DECISION_B2C.md`**

**B2Cプレミアムの月額だけが、コードのどこにも定義されていません。** 店舗プラン
（3,980 / 9,800 / 14,800円）と fleet（4,980 / 9,800円）は決まっています。
**特商法の「販売価格」欄（P2-14）が埋まらないのは、これが理由です。**
