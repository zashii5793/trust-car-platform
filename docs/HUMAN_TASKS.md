...
- [ ] **App Store 用スクリーンショットを撮影**
  - 必須サイズ: iPhone 6.7" (1290×2796px), 6.5" (1242×2688px)
  - 推奨: iPad 12.9" も用意
  - 各画面: ログイン・ホーム・車両詳細・整備記録・SNSフィード の5枚以上

- [ ] **Google Play 用スクリーンショットを撮影**
  - 最低2枚、推奨8枚
  - フィーチャーグラフィック (1024×500px) も必要
