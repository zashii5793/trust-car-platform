      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            _TermsSection(
              title: '第8条（免責事項）',
              content: '1. ZAXEL LLC（以下「当社」）は、本サービスの利用によりユーザーに生じた損害について、'
                  '当社の故意または重過失による場合を除き、一切の責任を負いません。\n'
                  '2. 当社は、ユーザーが入力・取得した整備記録・車両情報、および書類の読み取り（OCR）'
                  'による抽出結果の正確性・完全性を保証しません。これらは参考情報であり、'
                  '内容の確認はユーザーの責任で行うものとします。\n'
                  '3. 整備・点検・修理等の作業の要否や安全性については、必ず整備士等の専門家に'
                  'ご相談ください。\n'
                  '4. ユーザー間の取引・やり取りについて、当社は当事者ではなく、商品・代金・品質・'
                  '引渡し・その他一切のトラブルについて責任を負いません。',
            ),
            _TermsSection(
              title: '第8条の2（AI提案・予測・通知に関する免責）',
              content: '1. 本サービスのAIによる提案（パーツ・カスタム・車両の買い替え等）、'
                  '消耗品の交換時期・点検時期・車検時期の予測および通知は、一般的な目安を'
                  '提供するものであり、その正確性・適合性・結果を保証しません。\n'
                  '2. AIの提案は判断材料の提供であり、最終的な判断・選択はユーザーが行うものとします。'
                  '当社は、AIの提案に基づくユーザーの決定・行動の結果について責任を負いません。\n'
                  '3. 車検・法定点検等の法定期限の管理は、最終的にユーザーの責任で行うものとし、'
                  '当社の通知の有無・内容にかかわらず、期限の超過等によりユーザーに生じた損害について'
                  '当社は責任を負いません。',
            ),
            _TermsSection(
              title: '第8条の3（提携整備工場・販売店との連携）',
              content: '1. 本サービスは、ユーザーと提携する整備工場・販売店等の事業者をつなぐ「場」を'
                  '提供するものであり、当社はユーザーと事業者の間の取引・契約の当事者ではありません。\n'
                  '2. 事業者が提供するサービスの内容・品質・料金・対応について、当社は保証せず、'
                  'これらに起因する紛争・損害について責任を負いません。\n'
                  '3. 事業者への問い合わせ・連絡は、ユーザー自身の意思に基づいて行うものとします。',
            ),
            _TermsSection(
              title: '第9条（退会）',
            ...
            _TermsSection(
              title: '運営者・お問い合わせ',
              content: '運営会社: ZAXEL LLC\n'
                  'サポート: TrustCar サポートチーム\n'
