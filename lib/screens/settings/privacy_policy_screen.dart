      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            Text(
              '最終更新日: 2026年9月1日（社長確認前のドラフトです。反映前に専門家確認のうえ確定してください）',
            ...
            _PolicySection(
              ...
              content: '法人その他の団体（以下「契約法人」）が社用車を一括管理する fleet 機能をご利用の場合、'
                  ...
                  '【要記入: 専門家確認のうえ、法人向け契約またはfleet利用規約で別途定めるか判断】です',
            ),
            _PolicySection(
            ...
            _PolicySection(
              ...
              content: '・アカウント情報：退会後30日間保持後、削除\n'
                  ...
                  'C2C取引の記録については、法令（税法・電子帳簿保存法等）に基づき、'
                  '上記より長い期間の保存が必要となる場合があります。【要記入: 専門家確認のうえ保存期間を定める】',
            ),
            _PolicySection(
              title: '10. ユーザーの権利',
            ...
            _PolicySection(
              title: '13. 運営者',
              content: 'ZAXEL合同会社【要記入: 代表者名・所在地・電話番号は「特定商取引法に基づく表示」に記載】',
            ),
            _PolicySection(
              title: '14. お問い合わせ',
